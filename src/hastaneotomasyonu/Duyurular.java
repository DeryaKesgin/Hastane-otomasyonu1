...
public class Duyurular {
    ...
    File alanfile = new File("Duyuru Hasta.txt");
    ...
    static void AlanDuyuruDegistir()throws IOException{
        ...
        alanlar.set(Hasta.i,yazil);
        PrintWriter writer = new PrintWriter("Duyuru Hasta.txt");
        writer.print("");
        writer.close();
        FileOutputStream out = new FileOutputStream("Duyuru Hasta.txt", true);
...
//        }
    ...
    static String[] alanstrdoldur(){
        alanstr = ((String)alanlar.get(Hasta.i)).split(",");
        return alanstr;
    }
}
