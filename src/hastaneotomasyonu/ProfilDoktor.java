...
import static hastaneotomasyonu.Doktor.idler;
import static hastaneotomasyonu.Doktor.isimler;
import static hastaneotomasyonu.Doktor.soyisimler;



class ProfilDoktor extends JFrame implements ActionListener{
    ...
    ProfilDoktor(){
        ...
        this.setLayout(null);
        this.setTitle("Öğretim Üyesi Profil Penceresi");
        this.add(id);
        this.add(isim);
        this.add(soyisim);
        this.add(idtxt);
