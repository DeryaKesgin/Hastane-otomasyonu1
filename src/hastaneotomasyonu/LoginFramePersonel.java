...
class LoginFramePersonel extends JFrame implements ActionListener{
    ...
    public LoginFramePersonel(){
        ...
        this.setLayout(null);
        this.setTitle("Personel Penceresi");
        this.add(şifrel);
        this.add(pass);
        this.add(login1);
        this.add(id);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==login1){
            ...
            try {
                ...
                Logger.getLogger(LoginFrameHasta.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        if(e.getSource()==back)
        {
