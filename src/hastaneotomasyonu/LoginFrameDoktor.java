...
class LoginFrameDoktor extends JFrame implements ActionListener{
    ...
    String a,b;
    Doktor ogretim;
    public LoginFrameDoktor(){
        try {
            this.ogretim = new Doktor();
        } catch (IOException ex) {
            Logger.getLogger(LoginFrameDoktor.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        this.setLayout(null);
        this.setTitle("Doktor Penceresi");
        this.add(şifrel);
        this.add(pass);
        this.add(login1);
        this.add(id);
