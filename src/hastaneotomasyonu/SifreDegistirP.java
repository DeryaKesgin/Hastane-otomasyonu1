...
import static hastaneotomasyonu.Personel.i;
import static hastaneotomasyonu.Personel.idler;


class SifreDegistirP extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==değiştir){
            ...
            try {
                ...
                Logger.getLogger(SifreDegistirP.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
