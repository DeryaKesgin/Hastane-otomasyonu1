...
class Hasta extends Üye implements İnsan{
    static int i = 0;
    ...
    static ArrayList randevular_hasta = new ArrayList<>();
    static ArrayList ilaclar_hasta = new ArrayList<>();
    static ArrayList sikayet_hasta = new ArrayList<>();
    static ArrayList tani_hasta = new ArrayList<>();
    static File idfile = new File("Hasta ID.txt");
    static File şifrefile = new File("Hasta Şifre.txt");
    static File isimfile = new File("Hasta İsim.txt");
    static File soyisimfile = new File("Hasta Soyisim.txt");
    static File harfnotfile = new File("Hasta Reçete.txt");
    static File arasınavfile = new File("Hasta Şikayet.txt");
    static File finalfile = new File("Hasta Tanı.txt");
    static File dersfile = new File("Hasta Poliklinik.txt");
    static String z = "\n";
    ...
    public boolean giriş(String a, String b) throws IOException{
        ...
        randevular_hasta.clear();
        while(true){
            String yazi1 = br4.readLine();
            if (yazi1 != null)
                randevular_hasta.add(yazi1);
            else
                break;
        }
        ilaclar_hasta.clear();
    ...
    public boolean kayıt(String a,String b, String c, String d) throws IOException{
        ...
        FileOutputStream oqt = new FileOutputStream("Duyuru Hasta.txt",true);
