...
import static hastaneotomasyonu.Hasta.i;
import static hastaneotomasyonu.Hasta.idler;
import static hastaneotomasyonu.Hasta.isimler;
import static hastaneotomasyonu.Hasta.soyisimler;


class ProfilOgrenci extends JFrame implements ActionListener{
    ...
    ProfilOgrenci(){
        ...
        this.setLayout(null);
        this.setTitle("Öğrenci Profil Penceresi");
        this.add(id);
        this.add(isim);
        this.add(soyisim);
        this.add(idtxt);
