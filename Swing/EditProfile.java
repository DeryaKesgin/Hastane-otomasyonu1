...
public class EditProfile extends JFrame {
	...
	private JLabel BIAhospitaltext;
	...
	public EditProfile(HospitalManagementSystem manager, Person person) {
		...
		BIAhospitaltext = new JLabel("BIA HOSPITAL");
		BIAhospitaltext.setForeground(new Color(0, 0, 102));
		BIAhospitaltext.setFont(new Font("Verdana", Font.BOLD, 36));
		BIAhospitaltext.setBounds(274, 48, 326, 59);
		contentPane.add(BIAhospitaltext);
